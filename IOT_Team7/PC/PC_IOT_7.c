...
void display_menu() {
    ...
    printf("             MENU OPTIONS            \n");
    printf("=====================================\n");
    printf("1. Set Sample period\n");
    printf("2. Set advertising period for BLE\n");
    printf("3. Get temperature and humidity info\n");
    printf("0. Exit\n");
    printf("=====================================\n");
...
int main() {
    ...
    do {
        ...
        switch (choice) {
        case 1: {
            printf("Enter sample period value: ");
            int sample_period;
        ...
        case 2: {
            printf("Enter advertising period value: ");
            int adv_period;
            scanf("%d", &adv_period);
            getchar();
